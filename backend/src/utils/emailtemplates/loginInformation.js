...
const loginInfoEmailTemplate = (resetPasswordLink, fullName, browser, os) => {
    let text = `
                <html >
                    <head>
                        <meta charset="utf-8">
                                ...
                                <div style="padding:134px 83px 0px 83px; color:#fff;">
                                    <div style="border-bottom: 3px solid #29B79D;">
                                        <div style="margin-bottom: 60px; color: rgb(255 255 255);">
                                            ...
                                            <p style="font-family: 'Montserrat'; color: rgb(255 255 255); font-weight: 400; font-size: 14px; line-height: 17px;">Welcome to StarBitrex. You are recently loggind in from ${browser} browser using ${os} operating system. </p>
                                            <p style="font-family: 'Montserrat'; color: rgb(255 255 255); font-weight: 400; font-size: 14px; line-height: 17px;">If it is not you, change your password by clicking the link below. </p>
                                            <p style="font-family: 'Montserrat'; color: rgb(255 255 255); font-weight: 400; font-size: 14px; line-height: 17px; margin-bottom: 36px;"><span style="font-weight:800;">Reset Password Link: </span> <a href=${resetPasswordLink} target="_blank" style="cursor:pointer;  color:#29B79D;">${resetPasswordLink}</a>
                                            </p>
...
module.exports = { loginInfoEmailTemplate };