...
const exchangeCurrencyEmailTemplate = (fullName, currencyDetails) => {
    let text = `
                <html >
                    <head>
                        <meta charset="utf-8">
                                ...
                                <div style="padding:134px 83px 0px 83px; color:#fff;">
                                    <div style="border-bottom: 3px solid #29B79D;">
                                        <div style="margin-bottom: 60px; color: rgb(255 255 255);">
                                            ...
                                            <p style="font-family: 'Montserrat'; color: rgb(255 255 255); font-weight: 400; font-size: 14px; line-height: 17px;">Your order for currency exhange has been confirmed. </p>
                                            <p style="font-family: 'Montserrat'; color: rgb(255 255 255); font-weight: 400; font-size: 14px; line-height: 17px;">The details for currency exchange is as follows: </p>
                                            <p style="font-family: 'Montserrat'; margin: 0; color: rgb(255 255 255); font-weight: 400; font-size: 14px; line-height: 17px;"><span style="font-weight:800;">You paid: </span> ${currencyDetails.paid_amount} ${currencyDetails.paid_currency}
                                            </p>
                                            <p style="font-family: 'Montserrat'; margin: 0; color: rgb(255 255 255); font-weight: 400; font-size: 14px; line-height: 17px;"><span style="font-weight:800;">You received: </span> ${currencyDetails.received_amount} ${currencyDetails.received_currency}
                                            </p>
                                            <p style="font-family: 'Montserrat'; margin: 0; color: rgb(255 255 255); font-weight: 400; font-size: 14px; line-height: 17px;"><span style="font-weight:800;">Coversion Fee: </span> ${currencyDetails.coversion_fee}
                                            </p>
                                            <p style="font-family: 'Montserrat'; margin: 0; color: rgb(255 255 255); font-weight: 400; font-size: 14px; line-height: 17px; margin-bottom: 36px;"><span style="font-weight:800;">Exchange Rate: </span> ${currencyDetails.exchange_rate}
                                            </p>
...
module.exports = { exchangeCurrencyEmailTemplate };