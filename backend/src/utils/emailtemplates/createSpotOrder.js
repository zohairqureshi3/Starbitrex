...
const createSpotOrderEmailTemplate = (fullName, orderDetails) => {
    let text = `
                <html >
                    <head>
                        <meta charset="utf-8">
                                ...
                                <div style="padding:134px 83px 0px 83px; color:#fff;">
                                    <div style="border-bottom: 3px solid #29B79D;">
                                        <div style="margin-bottom: 60px; color: rgb(255 255 255);">
                                            ...
                                            <p style="font-family: 'Montserrat'; color: rgb(255 255 255); font-weight: 400; font-size: 14px; line-height: 17px;">Your spot order has been created successfully.</p>
                                            ...
                                            <p style="font-family: 'Montserrat'; margin: 0; color: rgb(255 255 255); font-weight: 400; font-size: 14px; line-height: 17px;"><span style="font-weight:800;">Order Type: </span> ${orderDetails.order_type}
                                            </p>
                                            <p style="font-family: 'Montserrat'; margin: 0; color: rgb(255 255 255); font-weight: 400; font-size: 14px; line-height: 17px;"><span style="font-weight:800;">Order Direction: </span> ${orderDetails.order_direction}
                                            </p>
                                            <p style="font-family: 'Montserrat'; margin: 0; color: rgb(255 255 255); font-weight: 400; font-size: 14px; line-height: 17px;"><span style="font-weight:800;">Order Value: </span> ${orderDetails.order_value} ${orderDetails.order_value_symbol}
                                            </p>
                                            <p style="font-family: 'Montserrat'; margin: 0; color: rgb(255 255 255); font-weight: 400; font-size: 14px; line-height: 17px;"><span style="font-weight:800;">Order Quantity: </span> ${orderDetails.order_qty} ${orderDetails.order_qty_symbol}
                                            </p>
                                            <p style="font-family: 'Montserrat'; margin: 0; color: rgb(255 255 255); font-weight: 400; font-size: 14px; line-height: 17px; margin-bottom: 36px;"><span style="font-weight:800;">Order Price: </span> ${orderDetails.order_price} ${orderDetails.order_price_symbol}
                                            </p>
...
module.exports = { createSpotOrderEmailTemplate };