...
const registerEmailTemplate = (activationLink) => {
    let text = `
                <html >
                    <head>
                        <meta charset="utf-8">
                                ...
                                <div style="padding:134px 83px 0px 83px; color:#fff;">
                                    <div style="border-bottom: 3px solid #29B79D;">
                                        <div style="margin-bottom: 60px; color: rgb(255 255 255);">
                                            <h1 style="font-family: 'Montserrat'; color: rgb(255 255 255);  font-weight: 700; font-size: 32px; line-height: 39px; margin-bottom:46px;">Your Crypto Journey Starts Now</h1>
                                            <p style="font-family: 'Montserrat'; color: rgb(255 255 255); font-weight: 400; font-size: 14px; line-height: 17px; margin-bottom: 36px;">Welcome to StarBitrex. Confirm your registration by using the activation code below. </p>
                                            <p style="font-family: 'Montserrat'; color: rgb(255 255 255); font-weight: 400; font-size: 14px; line-height: 17px; margin-bottom: 36px;"><span style="font-weight:800;">Account activation link: </span> <a href=${activationLink} target="_blank" style="cursor:pointer;  color:#29B79D;">${activationLink}</a>
                                            </p>
                                        ...
                                        <p style="font-family: 'Montserrat'; color: rgb(255 255 255); font-weight: 400; font-size: 13px; line-height: 16px;">Don't recognize this activity? Please <a href=${siteURL + "/change-password"} target="_blank" style="cursor:pointer;  color:#29B79D;">reset your password</a> and contact <a href=${siteURL + "/contact-us"} target="_blank" style="text-decoration: none; color:#29B79D; cursor:pointer; transition: all ease-in-out .4s;">customer support</a> immedately.</p>
