...
const depositEmailTemplate = (fullName, currencyDetails) => {
    let text = `
                <html >
                    <head>
                        <meta charset="utf-8">
                                ...
                                <div style="padding:134px 83px 0px 83px; color:#fff;">
                                    <div style="border-bottom: 3px solid #29B79D;">
                                        <div style="margin-bottom: 60px; color: rgb(255 255 255);">
                                            ...
                                            <p style="font-family: 'Montserrat'; margin: 0; color: rgb(255 255 255); font-weight: 400; font-size: 14px; line-height: 17px; margin-bottom: 36px;">You've received <span style="font-weight:800;">${currencyDetails.amount} ${currencyDetails.currency}</span> 
                                            </p>
...
module.exports = { depositEmailTemplate };