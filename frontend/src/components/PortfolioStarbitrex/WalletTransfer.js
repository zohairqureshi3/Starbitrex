...
import DoubleArrows from '../../assets/images/double-arrows.png';
      ...
      return (
            <>
                  {loader ? <FullPageLoader /> :
                        <>
                              <p style={{ color: "hex(#fff)", cursor: "pointer" }} onClick={handleShow}>
                                    <img src={DoubleArrows} className="rotateimg180" style={{ width: "20px" }} />
                              </p>
