...
const TradePage = () => {
  ...
  return (
    <>
      <TradeInfo ticketData={ticketData} currentMarketPrice={currentMarketPrice} futureTradesAPI={futureTradesAPI} orderBookAPI={orderBookAPI} sendPairtoParent={(pair) => setPairName(pair)} />
    </>
  )
}
