...
import { deleteUser, editUser, showRetenTeamleads } from '../../redux/users/userActions';
...
const RetenTeamleads = () => {

   const dispatch = useDispatch();
   const [loader, setLoader] = useState(false);
   const retenTeamleads = useSelector(state => state.users?.retenTeamleads);
               ...
               <div className="content-wrapper right-content-wrapper">
                  <div className="content-box">
                     ...
                     <table className="table mt-3 table-responsive table">
                        ...
                        <tbody>
                           {retenTeamleads && retenTeamleads.length > 0 ? retenTeamleads.map((data) => {
                              return (
                                 <tr key={data?._id}>
