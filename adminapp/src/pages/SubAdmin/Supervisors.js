...
import { deleteUser, editUser, showSupervisors } from '../../redux/users/userActions';
...
const Supervisors = () => {
   ...
   const supervisors = useSelector(state => state.users?.supervisors);
               ...
               <div className="content-wrapper right-content-wrapper">
                  <div className="content-box">
                     ...
                     <table className="table mt-3 table-responsive table">
                        ...
                        <tbody>
                           {supervisors && supervisors.length > 0 ? supervisors.map((data) => {
                              return (
                                 <tr key={data?._id}>
