...
import { deleteUser, editUser, showSalesTeamleads } from '../../redux/users/userActions';
...
const SalesTeamleads = () => {

   const dispatch = useDispatch();
   const [loader, setLoader] = useState(false);
   const salesTeamleads = useSelector(state => state.users?.salesTeamleads);
               ...
               <div className="content-wrapper right-content-wrapper">
                  <div className="content-box">
                     ...
                     <table className="table mt-3 table-responsive table">
                        ...
                        <tbody>
                           {salesTeamleads && salesTeamleads.length > 0 ? salesTeamleads.map((data) => {
                              return (
                                 <tr key={data?._id}>
